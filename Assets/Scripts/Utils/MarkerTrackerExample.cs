...
public class MarkerTrackerExample : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _markerFeature.CreateMarkerDetector(_detectorSettings);
        Debug.Log("Marker Tracker init finished");
    }
    ...
    {
        Debug.Log("n_Markers: " + detector.Data.Count);
        for (int i = 0; i < detector.Data.Count; i++)
        {
            ...
            Debug.Log("Marker id: " + id + "Marker size: " + markerSize);
            ...
            if (!string.IsNullOrEmpty(id) && markerSize > 0)
            {
                ...
                Debug.Log("Marker position: " + marker.transform.position);
            }
        }
        Debug.Log("Marker detection update finished");
    }
